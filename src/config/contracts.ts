export const CONTRACT_ADDRESS = '0xB199Fa79B39721aaCc5A39633899E2f8fE59C87c'; // xTicTacToe Escrow on Base
export const USDC_ADDRESS = '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913'; // Base USDC

export const ESCROW_ABI = [
  {
    inputs: [{ internalType: 'address', name: '_paymaster', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'address', name: 'opponent', type: 'address' }],
    name: 'createGame',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
    ...
    outputs: [
      {
        ...
        internalType: 'struct TicTacToeEscrow.Game',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    name: 'getPlayerStats',
    outputs: [
      { internalType: 'uint256', name: '_wins', type: 'uint256' },
      { internalType: 'uint256', name: '_losses', type: 'uint256' },
